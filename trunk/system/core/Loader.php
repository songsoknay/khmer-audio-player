...
class CI_Loader {
	 ...
	 * Load Template
	 *
	 * This function is used to load a "template" file.  It has four parameters:
	 *
	 * 1. The name of the "template" file to be included.
	 * 2. The name of the "view" file to be included.
	 * 3. The name of the "view" file to be included.
	 * 4. An associative array of data to be extracted for use in the view.
	 * 5. TRUE/FALSE - whether to return the data or load it.  In
	 * some cases it's advantageous to be able to return data so that
	 * a developer can process it in some way.
	 *
	 * @access	public
	 ...
	 * @author Sokha RUM
	 */
	function template($template, $main_view, $page_title, $vars = array(), $return = FALSE)
	{
		$vars = $vars == null ? array() : $vars; 
		$vars['z_main_body_view'] = $main_view;
		$vars['z_page_title'] = $page_title;
